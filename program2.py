...
class otp_verifier(Tk):
    def __init__(self):
        ...
        self.n = str(self.OTP())
        self.client = Client("ADD your twilio id", "ADD your twilio id ")
        self.client.messages.create(to =("ADD your phone no here or on which u want otp"),
                       from_ =" Write ur twilio no here",
                     body = self.n)
...
### Center textboxes
    ...
    def resendOTP(self):
        self.n = str(self.OTP())
        self.client = Client("ADD your twilio id", "ADD your twilio id")
        self.client.messages.create(to =("ADD your twilio number"),
                        from_ ="+19705145034",
                        body = self.n)
